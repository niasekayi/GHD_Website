...
_SECTIONS = [
    ...
    },
    {
        ...
        'body': (
            ...
            'by the relevant third-party provider(s). We may also, in the future, offer new services and/or features '
    ...
    },
    {
        ...
        'body': (
            ...
            'affiliated with us. We are not responsible for examining or evaluating the content or accuracy and we '
            'do not warrant and will not have any liability or responsibility for any third-party materials or '
    ...
    },
    {
        ...
        'body': (
            ...
            'trademark, privacy, personality or other personal or proprietary right. You are solely responsible for '
    ...
    },
    {
        ...
        'body': (
            ...
            'transmit viruses or any other type of malicious code; (h) to collect or track the personal information '
    ...
    },
    {
        ...
        'body': (
            ...
            'non-infringement.\n\n'
            'In no case shall All Things Good LLC, our directors, officers, employees, affiliates, agents, '
            ...
            'costs, or any similar damages, whether based in contract, tort (including negligence), strict liability '
            'or otherwise, arising from your use of any of the service or any products procured using the service.'
        ),
    },
    {
        'title': 'Section 14 – Indemnification',
        'body': (
            'You agree to indemnify, defend and hold harmless All Things Good LLC and our parent, subsidiaries, '
    ...
    },
    {
        ...
        'body': (
            ...
            'the Service constitute the entire agreement and understanding between you and us and govern your use '
            ...
            'Terms of Service). Any ambiguities in the interpretation of these Terms of Service shall not be '
    ...
    },
    {
        ...
        'body': (
            ...
            'by and construed in accordance with the laws applicable to All Things Good LLC, P.O. Box 841972, '
    ...
    },
    {
        ...
        'body': 'Questions about the Terms of Service should be sent to us at info@goodhairdaye.com.',
    },
]


def terms(request):
    return render(request, 'pages/terms/terms.html', {'sections': _SECTIONS})
