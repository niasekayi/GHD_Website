...
SALON_EMAIL = config('SALON_EMAIL', default='Goodhair.daye@yahoo.com')
...
DEFAULT_FROM_EMAIL  = config('DEFAULT_FROM_EMAIL', default='Good Hair Daye <Goodhair.daye@yahoo.com>')
