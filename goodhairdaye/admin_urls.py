...
urlpatterns = [
    ...
    path('api/appointments/add-manual/',              admin_views.api_add_manual_appointment,  name='ghd_api_add_manual_appt'),
    path('api/appointments/<int:appt_id>/delete/',    admin_views.api_delete_appointment,      name='ghd_api_delete_appt'),
